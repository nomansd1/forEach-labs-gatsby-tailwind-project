    ...
    return (
        <div className={`${darkmodeToggler && "dark"}`}>
            <div className='services_sec py-20'>
                <div className='w-[90%] md:w-[55%] mt-10 mx-auto flex items-center'>
                    <Slider {...settings} className='w-[100%] px-10 flex items-center justify-center testi_slider'>
                        <div className='testi_slide'>
                            <div class="flex flex-col items-center bg-white border border-gray-200 rounded-3xl shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:bg-[#281717] px-10 py-5">
                                <div className='flex items-center justify-center p-1 bg-[#f35544] rounded-full'>
                                    <img className="object-cover rounded-full md:h-auto md:w-[500px] border-[5px] border-white dark:border-[#281717] md:rounded-full" src={testimo} alt="" />
                                </div>
                                <div className="flex flex-col justify-between p-4 leading-normal">
                                    <img src={company2} className='w-28 -ml-2' />
                                    ...
                                    <i className='ml-24 font-medium'>. Director Marketing</i>
                                </div>
                            </div>
                        </div>
                        <div className='testi_slide'>
                            <div class="flex flex-col items-center bg-white border border-gray-200 rounded-3xl shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 px-10 py-5">
                                <div className='flex items-center justify-center p-1 bg-[#f35544] rounded-full'>
                                    <img className="object-cover rounded-full md:h-auto md:w-[500px] border-[5px] border-white dark:border-[#281717] md:rounded-full" src={testimo} alt="" />
                                </div>
                                <div className="flex flex-col justify-between p-4 leading-normal">
