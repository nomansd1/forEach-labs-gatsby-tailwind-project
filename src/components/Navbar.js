...
import { logo, lightMode } from '../images/index'
...
function Navbar() {
    ...
    return (
        <nav class={`${darkmodeToggler && 'dark'} bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600`}>
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="#" class="flex overflow-hidden h-14 items-center">
                    <img src={logo} class="h-28 mr-3 mt-6 sm:h-28" alt="Flowbite Logo" />
                </a>
                <div class="flex md:order-2">
                    <button type="button">
                        <img src={lightMode} alt="Light Mode" onClick={() => setDarkmodeToggler(!darkmodeToggler)} />
                    </button>
